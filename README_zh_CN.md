...
![schedule_manager_notebook](./images/schedule_manager_notebook.png)
...
## 功能
### 1. 添加日程分类
![add_schedule_category](./images/add_schedule_category.png)
...
![add_schedule](./images/add_schedule.png)

### 4. 更新日程
单机某个日程，会弹出更新日程的界面，可以修改日程的各种信息。同时修改对应文档中记录的信息。

![update_schedule](./images/update_schedule.png)
